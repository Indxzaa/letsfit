...
import { ArrowLeft, Flame, Trophy, Activity, Target, Zap, Lock } from 'lucide-react';
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <div className="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl"
                      style={{
                        background: isUnlocked ? rc.label : 'var(--border)',
                        boxShadow: isUnlocked ? `0 4px 12px ${rc.glow}` : 'none',
                      }}>
                  ...
                  {isUnlocked && (
                    <div className="text-xs font-bold mt-2" style={{ color: rc.label }}>✓ Unlocked</div>
                  )}
                </motion.div>
              );
            })}
